...
-- Step 6: Create Employee_Projects Table (Many-to-Many)
...
INSERT INTO logins (customer_id, login_date) VALUES
(1,'2023-01-15'),(1,'2023-01-16'),(1,'2023-01-17'),
(2,'2023-02-10'),(2,'2023-02-11'),
(3,'2023-03-05'),(3,'2023-03-06'),(3,'2023-03-07'),
(4,'2023-04-18'),(5,'2023-05-22'),(6,'2023-06-15'),
(7,'2023-07-20'),(8,'2023-08-05'),(9,'2023-09-10'),
(10,'2023-10-12'),(11,'2023-11-15'),(12,'2023-12-18'),
(13,'2023-01-05'),(14,'2023-02-28'),(15,'2023-03-15');
...
('Website Redesign'),('Mobile App Development'),('SEO Campaign'),('Product Launch');

INSERT INTO employee_projects (employee_id, project_id) VALUES
(4,1),(4,2),(12,2),(17,3),(18,3),(16,4),(6,4),(3,4);
...
('admin1', 'admin1@company.com', 'admin@123', 'admin'),
('john_doe', 'john@gmail.com', 'john@123', 'customer'),
('jane_smith', 'jane@gmail.com', 'jane@123', 'customer'),
('rohit_staff', 'rohit@company.com', 'rohit@123', 'staff'),
('priya_staff', 'priya@company.com', 'priya@123', 'staff'),
('aman_khan', 'aman@gmail.com', 'aman@123', 'customer'),
('riya_patel', 'riya@gmail.com', 'riya@123', 'customer'),
('arjun_dev', 'arjun@company.com', 'arjun@123', 'staff'),
('neha_customer', 'neha@gmail.com', 'neha@123', 'customer'),
('mohit_user', 'mohit@gmail.com', 'mohit@123', 'customer');
...
INSERT INTO employees (first_name, last_name, email, salary, dept_id, manager_id, join_date) VALUES
('John', 'Doe', 'john@example.com', 50000, 1, NULL, '2025-06-10'),
('Alice', 'Smith', 'alice@example.com', 60000, 2, 1, '2025-07-15'),
('Bob', 'Brown', 'bob@example.com', 55000, 3, 2, '2025-04-01'),
('Charlie', 'Davis', 'charlie@example.com', 70000, 3, 2, '2025-09-25'),
('David', 'Miller', 'david@example.com', 50000, 4, 1, '2025-08-05'),
('Eva', 'Taylor', 'eva@example.com', 60000, 4, 3, '2025-10-01'),
('Frank', 'White', 'frank@example.com', 70000, 5, 2, '2025-02-20'),
('Grace', 'Hall', 'grace@example.com', 70000, 5, 2, '2025-09-01'),
('Henry', 'King', 'henry@example.com', 50000, 1, 1, '2025-07-05'),
('Ivy', 'Lee', 'ivy@example.com', 60000, 2, 1, '2025-08-25'),
('John', 'Doe', 'john@example.com', 50000, 1, NULL, '2025-06-10'); -- duplicate email

-- 1) how to find duplicate email in the emp table
select email,count(*) from employees
group by email
having count(*) > 1;

-- 2) how to get highest salary in each department
select d.dept_name,max(e.salary) as highest_salary from employees as e
left join departments as d
on e.dept_id = d.dept_id
group by d.dept_name;

-- 3)how to find emp joined in last 3 months
select emp_id,first_name,join_date from employees
where join_date >= curdate() - interval 3 month;

-- 4)how to display first 5 records in sql
select * from employees
order by emp_id
limit 5;

-- 5)how to find no.of emp in each dept
select d.dept_name,count(*) from employees as e
left join departments as d
on e.dept_id = d.dept_id
group by d.dept_name;

-- 6)how to find last 3 record in sql
select * from employees
order by emp_id desc
limit 3;

-- 7)how to find emp without manager
select emp_id,first_name,last_name from employees
where manager_id is null;

-- 8)how to find firstname starting with a
select * from employees
where first_name like 'A%';

-- 9) how to fetch alternate rows from table
select * from employees
where emp_id %2 != 0;

-- 10)how to swap 2 column in sql
select emp_id,last_name,first_name from employees;

UPDATE employees
SET first_name = last_name,last_name = first_name;


-- 11)how to display duplicate records with their count
select email,count(*) from employees
group by email
having count(*) > 1;

-- 12)how to find highest salary without using max
select first_name,salary from employees
order by salary desc
limit 1;

-- 13)how to fetch common record from 2 table without using join
SELECT * FROM employees e1
WHERE EXISTS (
  SELECT 1 FROM employees2 e2
  WHERE e1.emp_id = e2.emp_id
);

-- 14)how to delete duplicate records from table
DELETE FROM employees
WHERE emp_id NOT IN (
...
-- 15)how to find dept with highest emp count
